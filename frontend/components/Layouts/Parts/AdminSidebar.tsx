                        ...
                        <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'systemadmin' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href="/admin/LogingUsers">{t('Loging History')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/admin/QuotaDoctors">{t('Quota Doctors')}</Link>
                                        </li>
                                        <li className="menu nav-item">
                                            <button
                                                type="button"
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'registrations' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('registrations')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Registrations')}</span>
                                    </div>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'registrations' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href="/admin/Patient">{t('Patient')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/admin/PatientRegistration">{t('Patient Registration')}</Link>
                                        </li>
                                        <li className="menu nav-item">
                                            <button
                                                type="button"
                            ...
                            <li className="menu nav-item">
                                <Link href="https://tsrs.com" target="_blank" className="nav-link group">
                                    <div className="flex items-center">

...
import Sidebar from './Parts/SuperAdminSidebar';
...
const SuperAdminLayout = ({ children }: PropsWithChildren) => {
    ...
    const sidebarMenus = [
        {
            ...
            items: [
                {
                    text: 'Dashboard',
                    icon: <IconMenuApps className="shrink-0 group-hover:!text-primary" />,
                    path: '/admin/dashboard',
                },
                {
                    text: 'System Admin',
                    icon: <IconMenuAuthentication className="shrink-0 group-hover:!text-primary" />,
                    path: '/item-1-2',
                    subItems: [
                        {
                            text: 'Loging History',
                            path: '/admin/LogingUsers',
                        },
                        {
                            text: 'Subitem 1-2-2',
                            path: '/subitem-1-2-2',
                            subItems: [
                                {
                                    text: 'Subitem 1-2-2-1',
                                    path: '/subitem-1-2-2-1'
                                },
                                {
                                    text: 'Subitem 1-2-2-2',
                                    path: '/subitem-1-2-2-2'
                                }
                            ]
                        },
                    ],
        ...
        },
        {
            ...
            items: [
                {
                    text: 'Item 2-1',
                    icon: <IconMenuDocumentation className="shrink-0 group-hover:!text-primary" />,
                    path: '/item-2-1',
                },
            ],
        },

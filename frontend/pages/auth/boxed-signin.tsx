    ...
    const submitForm = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                router.push('/'); // Replace with the actual path of your next page
                            ...
                            <div>
                                ...
                                <div className="relative text-white-dark">
                                    ...
                                    <span className="absolute start-4 top-1/2 -translate-y-1/2">
                                        {/* Assuming IconMail is a generic mail icon, you might want to replace it with an appropriate icon for a username */}
                                        <IconMail fill={true} />
                                    </span>
                                </div>
                            </div>
